...
summary(WAGP_model)
```
The R-square value is 0.2916, meaning that this model predicts about 29% of the variation in wage based on the four other variables. Most of the parameters are significant in predicting the results, with age, weekly work hours, and the ability to speak English being the most significant. On the other hand, citizenship is significant, but less so compared to the other variables. 
